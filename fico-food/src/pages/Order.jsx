    ...
    return (
        <div className='app w-full flex flex-row bg-white'>
            ...
            <div className='w-5/6 bg-white h-screen block ml-40     '>
                ...
                <div className='w-5/6 bg-white-200 h-4/6 ml-28 flex flex-row space-x-1  '>
                    <div className='w-4/6 bg- block space-y-4 pt-4 h-2/4 mr-4 sticky bottom-2'>
                        {/* <div className='solution bg-red-200 w-full block'> */}

                        {
                            boxer.map((boxes, index) => {

                                return (
                                    <div className='bg-[FCF8F8] w-12/12 flex mx-4 h-3/6   rounded-lg items-center space-x-6 justify-center border-2 border-[FCF8F8] shadow-md shadow-indigo-200'>
                                        <div className='image w-2/12 h-28'>
                        ...
                        <div class="grid grid-cols-1 divide-y  divide-black  bg-white shadow-md shadow-indigo-100 space-y-4 pt-12">
                            {
                                ...
                                options.map((opt, index) => {
                                    ...
                                    return (
                                        <div className='flex flex-col justify-center px-36 space-y-4 '>
